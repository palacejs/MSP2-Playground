// Supabase operations for main site (buttons, news)
...
// Database operations for main site
window.supabaseOperations = {
  // Dynamic Buttons
...
console.log('Supabase operations for main site loaded');
